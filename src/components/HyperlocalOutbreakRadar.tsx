...
export const HyperlocalOutbreakRadar: React.FC<HyperlocalOutbreakRadarProps> = ({
  ...
  const handleShareOnWhatsApp = (report: OutbreakReport) => {
    const text = `🚨 *KISAN MITRA CROP OUTBREAK ALERT / रोग चेतावनी* 🚨\n\n` +
      `⚠️ *Pest/Disease:* ${report.disease}\n` +
      `🌱 *Crop Affected:* ${report.crop}\n` +
      ...
      `🛡️ *PREVENTIVE SHIELD ACTION (पड़ोसी खेतों के लिए तुरंत बचाव छिड़काव):*\n` +
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl p-4 border border-gray-200 shadow-2xs flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-1.5 overflow-x-auto pb-1 max-w-full">
          <span className="text-xs font-bold text-gray-500 uppercase shrink-0 mr-1">Filter Crop:</span>
                ...
                <div className="flex flex-wrap items-center justify-between gap-2 border-b border-gray-100 pb-4">
                  <div>
                    ...
                    <p className="text-xs text-gray-600 mt-0.5">
                      Target Crop: <strong>{selectedOutbreak.crop}</strong> • Reported by {selectedOutbreak.reporterFarmer} ({selectedOutbreak.reportedAt})
                    </p>
                  </div>
                      ...
                      <button
                        ...
                        onClick={() =>
                          onOpenCalculator({
                            ...
                            cropName: selectedOutbreak.crop,
                            dosagePerLiter: 1.5,
                          })
                        }
