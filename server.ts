...
let outbreakReportsDatabase = [
  {
    id: 'outbreak-1',
    crop: 'Maize / मक्का',
    disease: 'Fall Armyworm (Spodoptera frugiperda) / फॉल आर्मीवर्म सुंडी',
    severity: 'high',
  ...
  },
  {
    id: 'outbreak-2',
    crop: 'Cotton / कपास',
    disease: 'Pink Bollworm (Pectinophora gossypiella) / गुलाबी सुंडी',
    severity: 'high',
  ...
  },
  {
    id: 'outbreak-3',
    crop: 'Tomato / टमाटर',
    disease: 'Early Blight & Leaf Curl / अगेती झुलसा व पर्ण कुंचन',
    severity: 'moderate',
  ...
  },
  {
    id: 'outbreak-4',
    crop: 'Paddy / धान',
    disease: 'Bacterial Leaf Blight (BLB) / जीवाणु झुलसा रोग',
    severity: 'moderate',
  ...
  },
  {
    id: 'outbreak-5',
    crop: 'Chilli / मिर्च',
    disease: 'Thrips & Murda Complex (Upward leaf curl) / थ्रिप्स व मुरड़ा रोग',
    severity: 'high',
